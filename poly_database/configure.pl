...
# This is a template for a configuration script of a bundled or autonomous extension.
# Please edit it according to your needs and rename it to configure.pl
# All subroutines defined below must stay defined, even if they do nothing.
...
#
# The option disabling this extension completely (in the case this is a bundled extension)
# is added automatically and should not be mentioned here.
# Please specify just the bare option keywords, without '--' prefix.
...
# and, finally, either fill (some of) the variables listed in @make_vars above, or die with a message
